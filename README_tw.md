...
[![Author](https://img.shields.io/badge/author-michaelliunsky-yellow?style=for-the-badge)](https://github.com/michaelliunsky) [![GitHub stars](https://img.shields.io/github/stars/michaelliunsky/niRvana-translate?color=ff69b4&style=for-the-badge)](https://github.com/michaelliunsky/niRvana-translate/stargazers)
...
在 [Release](https://github.com/michaelliunsky/niRvana-translate/releases) 頁面下載 .zip 檔案，在 WordPress 後台「外掛」頁面上傳並安裝。

# 使用引導

1. 在「翻譯語言設定」中新增語言並儲存。
2. 前往【外觀 → 選單】→ 左側 niRvana 翻譯選單 → 勾選並「新增至選單」。
...
niRvana-translate 使用 [GPL V3.0](https://github.com/michaelliunsky/niRvana-translate/blob/main/LICENSE) 授權條款開源，請遵守此條款進行二次開發等。

您**必須在外掛頁面保留 niRvana-translate 外掛的名稱及作者連結**，否則請不要使用 niRvana-translate 外掛。

# 更新日誌

見 [readme.md](https://github.com/michaelliunsky/niRvana-translate#%E6%9B%B4%E6%96%B0%E6%97%A5%E5%BF%97)

# 捐贈

如果你覺得 niRvana-translate 外掛不錯，可以請我喝杯咖啡來支持我的開發。
